...
__webpack_require__.d(__webpack_exports__, {
  "RenderProgressBar": () => (/* binding */ RenderProgressBar)
});
            ...
            for (var prop in currentSet) {
                if (currentSet.hasOwnProperty(prop)) {
                    ...
                    if (mergedValue === undefined) {
                        ...
                        mergedSet[prop] = tslib_es6_spreadArray(tslib_es6_spreadArray([], (Array.isArray(mergedValue) ? mergedValue : [mergedValue])), (Array.isArray(currentValue) ? currentValue : [currentValue]));
                    }
                }
            }
        }
...
var _rtl;
_rtl = getRTL();
function StyleOptionsState_getStyleOptions() {
    return {
        rtl: getRTL(),
    };
}
...
;// CONCATENATED MODULE: ./node_modules/@fluentui/react/lib/components/ProgressIndicator/ProgressIndicator.base.js
...
var HighContrastSelector = '@media screen and (-ms-high-contrast: active), @media screen and (forced-colors: active)';
 ...
 */
var EdgeChromiumHighContrastSelector = '@media screen and (-ms-high-contrast: active), @media screen and (forced-colors: active)';
...
;// CONCATENATED MODULE: ./node_modules/@fluentui/style-utilities/lib/styles/GeneralStyles.js
...
function keyframes(timeline) {
    ...
    for (var prop in timeline) {
        if (timeline.hasOwnProperty(prop)) {
            rulesArray.push(prop, '{', serializeRuleEntries(StyleOptionsState_getStyleOptions(), timeline[prop]), '}');
        }
    }
...
setVersion('@fluentui/style-utilities', '8.7.0');
...
function fontFace(font) {
    var stylesheet = Stylesheet.getInstance();
    var rule = serializeRuleEntries(StyleOptionsState_getStyleOptions(), font);
...
function getLanguage(persistenceType) {
    ...
    if (_language === undefined) {
        ...
        var savedLanguage = persistenceType === 'localStorage'
            ? localStorage_getItem(STORAGE_KEY)
...
initializeThemeInCustomizations();
//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ./node_modules/@fluentui/react/lib/components/ProgressIndicator/ProgressIndicator.styles.js
...
;// CONCATENATED MODULE: ./node_modules/@fluentui/react/lib/components/ProgressIndicator/ProgressIndicator.js
 ...
 */
var ProgressIndicator = styled(ProgressIndicatorBase, getStyles, undefined, { scope: 'ProgressIndicator' });
//# sourceMappingURL=ProgressIndicator.js.map
;// CONCATENATED MODULE: ./react/progressbar.jsx
  ...
  _createClass(Progress, [{
    ...
    value: function render() {
      return /*#__PURE__*/react.createElement(ProgressIndicator, {
        ...
        percentComplete: this.props.count % 10 * 0.1
      });
    }
  }]);
...
;// CONCATENATED MODULE: ./react/index.jsx



function RenderProgressBar(count) {
  (0,react_dom.render)( /*#__PURE__*/react.createElement(Progress, {
    count: count
  }), document.getElementById("reactProgressBar"));
}
})();
